    ...
    <div id="main-container">
       ...
       <div class="left-content">
        <div id="info-container">
            ...
            <div class="blog-text">
                <p>A vibrant land steeped in rich history. An island whose beauty stretches far beyond its spectacular shores. A world-famous dive site. A tranquil oasis, abundant with warm welcomes around every corner. Cozumel is a destination like no other. And you'll just have to take our word for it. Because it's impossible to imagine, until you've been here.</p> 
            </div>
            ...
            <div class="blog-img">
                ...
                <table class="mapas">
                    ...
                    <tr>
                        <td>
                          <a href="about_cozumel.php"><img class="borde" src="images/tourist_information/3.jpg" width="164" height="380" alt="About Cozumel" /></a></td>
                          <td><a href="where-to-stay.php"><img class="borde" src="images/tourist_information/1.jpg" width="164" height="380" alt="Where to Stay" /></a></td>
                          <td><a href="things-to-do.php"><img class="borde" src="images/tourist_information/2.jpg" width="164" height="380" alt="Things to Do" /></a></td>
                      </tr>
                      <tr>
                        <td colspan="3">
                            <br />
                    ...
                    <tr>
                        <td colspan="3"> <br />
                            <a href="how-to-get.php"><img class="borde" src="images/tourist_information/4.jpg" width="100%" height="137" alt="How to get to Cozumel" /></a></td>
                        </tr>
                    </table>
                </div>
                <div class="title_styling">
                ...
                <iframe width="590" height="650" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/maps/ms?msa=0&amp;msid=215312241564867698152.0004b695ccdcc988ee2d4&amp;ie=UTF8&amp;t=m&amp;vpsrc=6&amp;ll=20.456609,-86.911469&amp;spn=0.2464,0.42984&amp;z=11&amp;output=embed"></iframe></p>
